...
javadoc -author -version -private -encoding UTF-8 -charset UTF-8 -sourcepath .\src\ -d doc -classpath .\lib\* -link https://docs.oracle.com/en/java/javase/20/docs/api/ -subpackages brandubh