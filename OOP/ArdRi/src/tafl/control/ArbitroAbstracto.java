...
public abstract class ArbitroAbstracto implements Arbitro{
	 ...
	 */
	protected int numeroJugadas;
	
	/**
	 * Constructor de la clase
	 * 
	 * @param tableroParam parametro necesario para establecer el tablero del juego
	 */
	protected ArbitroAbstracto(Tablero tableroParam) {
	 ...
	 */
	public void colocarPiezas(TipoPieza[] arrayTiposPiezas, int[][] arrayCoordenada, Color turnoActual) throws CoordenadasIncorrectasException {
		if(turnoActual == null || arrayTiposPiezas == null || arrayCoordenada == null) {
			throw new IllegalArgumentException();
		}
	 ...
	 * @return boolean
	 */
	public abstract boolean haGanadoRey();
			...
			try {
				for(Celda celda : tablero.consultarCeldasContiguas(ultimaJugada.consultarDestino().consultarCoordenada())) {
					...
					if(celda.consultarPieza().consultarTipoPieza()== TipoPieza.REY) {
						// En caso afirmativo sale del bucle, confirmando que el rey se encuentra en una posible captura
	...
	public void mover(Jugada jugada) throws CoordenadasIncorrectasException {
		// Si no se pasa una jugada al método, lanza una excepción
		if(jugada == null){
			throw new IllegalArgumentException();
		}
		...
		if(!tablero.comprobarCoordenadas(celdaOrigen.consultarCoordenada()) || !tablero.comprobarCoordenadas(celdaDestino.consultarCoordenada())) {
	 ...
	 * @throws CoordenadasIncorrectasException excepción por coordenadas incorrectas
	 */
	public Coordenada obtenerCoordenadasRey() throws CoordenadasIncorrectasException{
	 ...
	 * @return boolean
	 */
	public boolean posibleCapturaAlRey() {		
	 ...
	 * @throws CoordenadasIncorrectasException excepción por coordenadas incorrectas
	 */
	public boolean comprobarCapturaReyEnTrono() throws CoordenadasIncorrectasException {
	 ...
	 * @throws CoordenadasIncorrectasException excepción por coordenadas incorrectas
	 */
	public boolean comprobarCapturaReyContiguoAlTrono() throws CoordenadasIncorrectasException {
		// Si el rey no se puede capturar se devuelve false
		if(ultimaJugada != null) {
			if(!posibleCapturaAlRey()) {
				return false;
	 ...
	 * @throws CoordenadasIncorrectasException excepción por coordenadas incorrectas
	 */
	public boolean comprobarCapturaReyNoContiguoAlTrono() throws CoordenadasIncorrectasException {
		// Si el rey no se puede capturar se devuelve false
		if(ultimaJugada != null) {
			if(!posibleCapturaAlRey()) {
				return false;
